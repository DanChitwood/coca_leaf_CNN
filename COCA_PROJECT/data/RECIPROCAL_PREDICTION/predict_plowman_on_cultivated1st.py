# predict_plowman_on_cultivated1st.py
#######################
### LOAD IN MODULES ###
#######################
...
# --- Paths Configuration ---
# Path to the trained model checkpoint (Plowman's model)
# Assumes this script is in RECIPROCAL_PREDICTION/
# and the model is in PLOWMAN/trained_models/
MODEL_PATH = Path("../PLOWMAN/trained_models/ECT_Mask_2Channel_CNN_Ensemble_Improved_fold0_best_Leaf_Class.pth")

# Path to the data for prediction (Cultivated1st's data)
# Assumes this script is in RECIPROCAL_PREDICTION/
# and the data is in CULTIVATED1ST/05_synthetic_leaf_data/
DATA_PATH = Path("../CULTIVATED1ST/05_synthetic_leaf_data/final_cnn_dataset.pkl")

# --- General Prediction Configuration ---
BATCH_SIZE = 32
SCRIPT_NAME = "Plowman Model Predicting on Cultivated1st Data"
OUTPUT_PREFIX = "Plowman_on_Cultivated1st" # Prefix for saved plots/reports
