...
def run_morphometric_analysis(metadata_df, image_data_base_dir, output_base_dir, analysis_name="combined_dataset"):
    ...
    CLASS_LABEL_COLUMN_FOR_SAVING = "plantID"
    ...
    required_cols_for_preprocessing = ["file", "dataset", "base_x", "base_y", "tip_x", "tip_y"]
    ...
    # Assumes image_data_base_dir is '..' from SYNTHETICPLANT
    # So, image_data_base_dir / 'CULTIVATED1ST' / '00_cultivated1st_data'
    image_dirs = {
    ...
    for i in range(len(cult_cm_arr)):
        ...
        # The rotation step already aligns the leaf such that the base is near origin and tip along positive y-axis.
        # So, length is the range of y-coordinates and width is the range of x-coordinates.
    ...
    with h5py.File(pca_scores_labels_filepath, 'w') as f:
        ...
        # Using string dtype for column names to match standard HDF5 attribute storage
    ...
    print(f"Original PCA scores, class labels, original flattened coordinates, AND derived morphometric traits saved to {pca_scores_labels_filepath}")
...
if __name__ == "__main__":
    ...
    # The image_data_base_dir will be used by the function to construct paths like
    # '../CULTIVATED1ST/00_cultivated1st_data' and '../CULTIVATED2ND/00_cultivated2nd_data'
