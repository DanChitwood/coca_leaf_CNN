...
# All outputs for this run will be saved inside this directory
EXPERIMENT_OUTPUT_BASE_DIR = COCA_PROJECT_BASE / "analysis" / "CULTIVATED1ST"
...
MODEL_IDENTIFIER = 'ECT_Mask_2Channel_CNN_Ensemble_Improved' # Unique identifier for this model/run

# --- Data Input Configuration ---
# Path to the final prepared dataset from the data generation script (02_synthetic_leaf_data.py)
# This path is now correctly set relative to the EXPERIMENT_OUTPUT_BASE_DIR,
# reflecting its actual location within the CULTIVATED1ST subfolder.
FINAL_PREPARED_DATA_FILE = EXPERIMENT_OUTPUT_BASE_DIR / "02_synthetic_leaf_data" / "final_cnn_dataset.pkl"
...
try:
    ...
    # This ensures consistency even if the original encoder object isn't saved.
...
if len(saved_model_paths_per_fold) > 0 and saved_model_paths_per_fold[0] is not None and os.path.exists(saved_model_paths_per_fold[0]):
    ...
    def show_cam_on_black_background(cam_heatmap, original_image_tensor, image_size_tuple):
        ...
        This function remains as originally provided by the user.
        """
