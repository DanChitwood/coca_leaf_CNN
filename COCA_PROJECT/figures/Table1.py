...
# If this script is in 'COCA_PROJECT/figures/', then BASE_PROJECT_DIR points to 'COCA_PROJECT/'
BASE_PROJECT_DIR = Path("../") # This path is correct for the script residing in 'figures/'
...
# Paths to the JSON files for each dataset (MODIFIED to point to 'analysis' instead of 'data')
JSON_PATHS = {
    "Plowman": BASE_PROJECT_DIR / "analysis" / "PLOWMAN" / "trained_models" / "metrics_output" / JSON_FILENAME,
    "Cultigens (1st)": BASE_PROJECT_DIR / "analysis" / "CULTIVATED1ST" / "trained_models" / "metrics_output" / JSON_FILENAME,
    "Wildspecies": BASE_PROJECT_DIR / "analysis" / "WILDSPECIES" / "trained_models" / "metrics_output" / JSON_FILENAME,
}

# Output directory for the performance table (MODIFIED to be current directory)
...
OUTPUT_TABLE_FILENAME = "Table1.csv" # MODIFIED: Output filename is "Table1.csv"
